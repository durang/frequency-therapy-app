          ...
          <div className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 sm:gap-3">
            ...
            {breathingActive && (
              <button onClick={() => setBreathingSettingsOpen(!breathingSettingsOpen)}
                className="p-2 rounded-full border border-white/[0.06] text-white/20 hover:text-white/40 hover:border-white/10 transition-all duration-300" aria-label="Settings">
