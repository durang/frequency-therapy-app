...
export const FREQUENCY_CONNECTIONS: FrequencyConnection[] = [
  ...
  { fromSlug: 'anxiety-liberation', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Synergistic', explanation: '432 Hz reduces cortisol while 528 Hz repairs cellular damage from chronic stress. Together they form the core of the Anxiety Relief Protocol.', protocol: 'anxiety' },
  ...
  { fromSlug: 'dna-repair', toSlug: 'stem-cell-activation', toName: 'Stem Cell Activation', toHz: 174, relationship: 'Sequential', explanation: '174 Hz activates regenerative stem cells; 528 Hz provides the DNA repair template. 174 Hz rebuilds tissue, 528 Hz ensures genetic fidelity.', protocol: 'pain' },
  { fromSlug: 'dna-repair', toSlug: 'telomere-guardian', toName: 'Telomere Guardian', toHz: 963, relationship: 'Complementary', explanation: '528 Hz repairs active DNA damage. 963 Hz protects telomeres — the chromosomal aging clock. Repair + prevention.' },
  ...
  { fromSlug: 'deep-sleep-delta', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Synergistic', explanation: 'Deep sleep is when your body performs most DNA repair. Delta maximizes sleep depth; 528 Hz provides the repair frequency template.' },
  ...
  { fromSlug: 'stem-cell-activation', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Complementary', explanation: '174 Hz activates stem cells. 528 Hz ensures new cells have properly repaired DNA. Regeneration + genetic integrity.', protocol: 'healing' },

  // 285 Hz Pain Relief
  { fromSlug: 'pain-relief-matrix', toSlug: 'stem-cell-activation', toName: 'Stem Cell Activation', toHz: 174, relationship: 'Sequential', explanation: '285 Hz repairs tissue; 174 Hz provides foundational pain relief. Together: first two phases of the Pain Protocol.', protocol: 'pain' },
  ...
  { fromSlug: 'universal-healing-frequency', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Synergistic', explanation: '10000 Hz = broad-spectrum cellular stimulation. 528 Hz = DNA repair fidelity. Universal Healing Protocol combines both.', protocol: 'healing' },
  ...
  // 852 Hz Epigenetic
  { fromSlug: 'epigenetic-optimization', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Sequential', explanation: '528 Hz repairs DNA structure. 852 Hz influences gene expression (epigenetics). Repair the code → optimize which parts activate.' },
  ...
  // 963 Hz Anti-Aging
  { fromSlug: 'telomere-guardian', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Complementary', explanation: '963 Hz protects telomeres (aging clock). 528 Hz repairs active DNA damage. Protection + repair = anti-aging.' },
  { fromSlug: 'telomere-guardian', toSlug: 'stem-cell-activation', toName: 'Stem Cell Activation', toHz: 174, relationship: 'Synergistic', explanation: 'Telomere preservation (963 Hz) keeps cells young. Stem cell activation (174 Hz) creates new cells. Young + new = regeneration.' },
  ...
  { fromSlug: 'mitochondrial-boost', toSlug: 'dna-repair', toName: 'DNA Repair', toHz: 528, relationship: 'Complementary', explanation: 'Mitochondria have their own DNA (mtDNA). 55 Hz boosts mitochondrial function; 528 Hz repairs the mtDNA that keeps them running.' },
]
