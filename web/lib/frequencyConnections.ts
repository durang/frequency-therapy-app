...
export const FREQUENCY_CONNECTIONS: FrequencyConnection[] = [
  ...
  // 174 Hz Stem Cell
  { fromSlug: 'stem-cell-activation', toSlug: 'pain-relief', toName: 'Pain Relief', toHz: 285, relationship: 'Sequential', explanation: '174 Hz (lowest solfeggio) relieves pain and security. 285 Hz heals tissue. Pain Protocol: 174 Hz relieves → 285 Hz repairs.', protocol: 'pain' },
  ...
  // 285 Hz Pain Relief
  { fromSlug: 'pain-relief', toSlug: 'stem-cell-activation', toName: 'Deep Restoration', toHz: 174, relationship: 'Sequential', explanation: '285 Hz repairs tissue; 174 Hz provides foundational pain relief. Together: first two phases of the Pain Protocol.', protocol: 'pain' },
  { fromSlug: 'pain-relief', toSlug: 'universal-healing-frequency', toName: 'Universal Healing', toHz: 10000, relationship: 'Synergistic', explanation: '285 Hz = precision tissue repair. 10000 Hz = broad-spectrum cellular support. Targeted + systemic healing.', protocol: 'pain' },
  ...
  { fromSlug: 'universal-healing-frequency', toSlug: 'pain-relief', toName: 'Pain Relief', toHz: 285, relationship: 'Complementary', explanation: '10000 Hz (Swiss army knife) + 285 Hz (precision tool). Pain Protocol uses both for complete coverage.', protocol: 'pain' },
