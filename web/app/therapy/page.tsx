        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-xl font-semibold text-gray-900">Frequency Therapy</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Frequency Type</span>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                    currentFreq?.tier === 'free' ? 'bg-gray-100 text-gray-800' :
                    currentFreq?.tier === 'basic' ? 'bg-blue-100 text-blue-800' :
                    currentFreq?.tier === 'pro' ? 'bg-purple-100 text-purple-800' :
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">{currentFreq?.duration_minutes} min</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Research Citations</span>
                  <span className="font-medium">{currentFreq?.research_citations?.length || 0}</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Session Tips</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            {relatedFrequencies.length > 0 && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Related Frequencies</CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <div className={`ml-3 px-2 py-1 text-xs font-medium rounded ${
                            freq.tier === 'free' ? 'bg-gray-100 text-gray-800' :
                            freq.tier === 'basic' ? 'bg-blue-100 text-blue-800' :
                            freq.tier === 'pro' ? 'bg-purple-100 text-purple-800' :
                            'bg-gold-100 text-gold-800'
                          }`}>
                            {freq.tier}
                          </div>
            ...
            <CardContent>
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-2">Scientific Note</h4>
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading therapy session...</p>
        </div>
      </div>
    }>
      <TherapyContent />
