        ...
        <div className="gsap-fade-in max-w-4xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="gsap-fade-in bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              ...
              <p className="text-sm text-white/35 leading-relaxed">Delta frequencies at 1.5 Hz are below conscious hearing — binaural beats deliver them to your brain</p>
            </div>
            <div className="gsap-fade-in bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              <div className="text-3xl mb-4">🌊</div>
              <h3 className="text-base font-medium mb-2">Brain waves slow down</h3>
              <p className="text-sm text-white/35 leading-relaxed">Your neural activity gradually shifts from beta (alert) to delta (deep sleep) over 15-20 minutes</p>
            </div>
            <div className="gsap-fade-in bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6">
              <div className="text-3xl mb-4">💤</div>
              <h3 className="text-base font-medium mb-2">Deep sleep activates</h3>
              <p className="text-sm text-white/35 leading-relaxed">Growth hormone releases, glymphatic system cleans the brain, memories consolidate</p>
            </div>
          </div>
        </div>
        ...
        <div className="gsap-fade-in max-w-2xl mx-auto mb-20">
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-8">
            <p className="text-sm text-white/50 leading-relaxed mb-4">
              &ldquo;Music-based interventions significantly reduced physiological stress markers including cortisol levels and heart rate variability across multiple controlled trials.&rdquo;
            </p>
            <p className="text-xs text-white/25">
              de Witte M, Spruit A, van Hooren S, et al. (2020). Effects of music interventions on stress-related outcomes.{' '}
              <a href="https://doi.org/10.1080/17437199.2019.1627897" target="_blank" rel="noopener noreferrer" className="text-indigo-400/50 hover:text-indigo-400/80 underline">
